...
package utils
{
	 ...
	 */
	public class MyBase64Decoder extends EventDispatcher implements IEventDispatcher
	{
		//--------------------------------------------------------------------------
		//
		//  Constructor
		 ...
		 *  @productversion Flex 3
		 */
		public function MyBase64Decoder()
		{
			super();
			data = new ByteArray();
		}
		...
		public static const BYTES_CONVERTED:String = "bytesConverted";
		...
		public function decode(encoded:String):void
		{
			...
			dispatchEvent(new Event(BYTES_CONVERTED));
		}
