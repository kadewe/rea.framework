package Shared
{
	 ...
	 * 
	 * Code is modified by Jan Kuester, University of bremen jank87@tzi.de
	...
	public class HorizontalMultilineLayout extends LayoutBase
	{
		...
		override public function updateDisplayList(width:Number, height:Number):void
		{
			...
			for (i = 0; i < n; i++)
			{
				...
				if (!element || !element.includeInLayout)
					continue;
				var yh  = _verticalLayoutInLine==VerticalAlign.MIDDLE?(maxLineHeight - element.getPreferredBoundsHeight())/2:_verticalLayoutInLine==VerticalAlign.BOTTOM?maxLineHeight - element.getPreferredBoundsHeight():0;
